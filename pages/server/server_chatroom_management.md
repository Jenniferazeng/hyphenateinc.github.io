...
Chat provides a REST API to manage chat rooms in APP.
...
The documentation details the REST APIs that need to be used for IM chat room integration, which can be found by using the [Chat REST API](http://api-docs.easemob.com/) embedded in the documentation.
